...
class relatorioordensservicoController extends controller{
    ...
    public function __construct() {
        ...
        $this->model = new Relatorioordensservico();
        ...
        if(in_array("relatorioordensservico_ver", $_SESSION["permissoesUsuario"]) == false){
    ...
    public function index() {
        ...
        if(isset($_POST) && !empty($_POST)){ 
            ...
            if(in_array("relatorioordensservico_exc", $_SESSION["permissoesUsuario"]) == false || empty($id) || !isset($id)){
                header("Location: " . BASE_URL . "/relatorioordensservico"); 
            }
        ...
        $dados["taxaSeg"] = $this->model->taxaSeguroOperacional();
        $dados["labelTabela"]["labelBrowser"] = 'Relatório de Ordens de Serviço';

        $this->loadTemplate('relatorioordensservico', $dados);
    }
    
    public function adicionar() {
        
        if(in_array("relatorioordensservico_add", $_SESSION["permissoesUsuario"]) == false){
            header("Location: " . BASE_URL . "/relatorioordensservico"); 
        }
