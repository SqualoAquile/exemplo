...
<section class="mb-5">
    <form id="form-principal" method="POST" class="needs-validation" autocomplete="false" novalidate>
        <div class="row">
            <?php foreach ($colunasOrcamentos as $key => $value): ?>
                    <?php if(isset($value["Comment"]) && array_key_exists("form", $value["Comment"]) && $value["Comment"]["form"] != "false") : ?>
                        ...
                        <?php elseif(array_key_exists("type", $value["Comment"]) && $value["Comment"]["type"] == "hidden"): ?>
                            ...
                            />
                        <?php else: ?>
                            <div class="col-lg-<?php echo isset($value["Comment"]["column"]) ? $value["Comment"]["column"] : "12" ?>" style="order:<?php echo isset($value["Comment"]["ordem_form"]) ? $value["Comment"]["ordem_form"] : 100 ?>;">
            ...
            <div class="card card-body mb-4">
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-3 col-lg-3">
                        <button id="btn_incluir" class="btn btn-primary btn-block mt-2">Incluir</button>
                    </div>
                </div>
